...
- Example: `/workspaces/Test-CA/Optimus Core/1_base repo/User Story/US_001.md`

- The prompt will ask: "Please provide the User Story file path:"
 
**Template Reference:** `/workspaces/Test-CA/Optimus Core/1_base repo/Template/Template.md`

**Navigation Steps Reference:** `/workspaces/Test-CA/Optimus Core/1_base repo/Reference/Navigationsteps.md`

**Output Location:** `/workspaces/Test-CA/Optimus Core/4_Design Studio/sampleoutput.md`
